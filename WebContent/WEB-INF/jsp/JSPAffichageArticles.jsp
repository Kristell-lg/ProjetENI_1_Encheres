...
<body>
	<div id="main">
		...
		<c:choose>
			<c:when test="${empty requestScope.erreur}">
				<div id="containerProfil">
					<div id="Profil">
						<p class="affichageArticle">Bonjour
							${sessionScope.utilisateur.getPseudo()} !</p>
						<p class="affichageArticle">Crédit :
							${sessionScope.utilisateur.getCredit()} points</p>
					</div>
					<div id="LienHeader">
						<a class="affichageArticle"
							href="/ProjetENI_1_Encheres/ServletCreationArticles">Mettre
							en vente un article</a>
						<p></p>
						<a class="affichageArticle" href="/ProjetENI_1_Encheres/Profil">Mon
							Profil</a>
						<p></p>
						<a class="affichageArticle"
							href="/ProjetENI_1_Encheres/Deconnexion">Déconnexion</a>
					</div>
				</div>
			</c:when>
		...
		<!-- à modifier selon selection voulu par l'utilisateur -->
				...
				<div id="position">
					<c:forEach var="article" items="${articlesListe}">
						<div id="container">
							...
							<p class="affichageArticle">Fin des enchères
								:${article.getDate_fin_encheres().format(DateTimeFormatter.ofPattern("dd-MM-yyyy"))}</p>
							<p class="affichageArticle">Prix initial
								:${article.getPrix_initial()}</p>
							<p class="affichageArticle">Dernier Prix
								:${article.getPrix_vente()}</p>
